...
// cierres felices del formulario pasan por intentaCotizar() y la cotización dispara igual.
{
  ...
  chequear('y sale el acuse inmediato (verificando disponibilidad y precios) mientras SAP responde',
           /verificando .*disponibilidad y precios/i.test(JSON.stringify(r.wpp_body||'')), JSON.stringify(r.wpp_body||'').slice(0,100));
