...
m={'Armar aviso a Deicy':'tests/n_armar.js','\u00bfLleg\u00f3 el aviso?':'tests/n_confirmar.js','Preparar IA':'tests/n_prepara.js'}
for n in w['nodes']:
...
rm -f tests/cerebro.js tests/n_armar.js tests/n_confirmar.js tests/n_prepara.js
